...
**https://demedpex.github.io/bridge-zero/**

`main` 에 올라오면 프론트를 빌드해서 GitHub Pages 로 올린다
([.github/workflows/deploy-pages.yml](.github/workflows/deploy-pages.yml)).

이 링크는 **화면을 확인하는 용도**다. 백엔드는 함께 올라가지 않으므로
마지막 "계산하기"는 동작하지 않고 "연결이 잠깐 끊겼어요" 안내가 뜬다.
끝까지 돌려보려면 아래 순서대로 로컬에서 띄운다.
